...
if (!String.prototype.repeat) {
  ...
  String.prototype.repeat = function(count) {
    ...
    count = Number(count);
    if (count < 0) {
      throw new RangeError("The number of repetitions must be positive");
    }
    if (count === Infinity) {
      throw new RangeError("The number of repetitions must be less than infinity");
    }
    ...
    if (str.length * count >= 1 << 28) {
      throw new RangeError("The number of repetitions should not exceed the maximum chain size");
    }
    var rpt = "";
